class Gmeng < Formula
  ...
  def install
    ...
    (buildpath/"gmeng.pc").write <<~EOS
      ...
      Libs: -L${prefix}/include -L${prefix}/include/gmeng/include -I${prefix}/include/sol/include -L${prefix} -L${prefix}/lib/bin
      Cflags: -I${prefix}/include -I${prefix}/include/gmeng/include -L${prefix}/include/sol/include -framework CoreMIDI -framework CoreFoundation -framework ApplicationServices -framework AudioUnit -framework CoreAudio -framework AudioToolbox -I${prefix} -I${prefix}/lib/bin #{engine_cflags}
    EOS
